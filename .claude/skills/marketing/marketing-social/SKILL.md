...
description: >
  Crea y optimiza contenido para redes sociales (LinkedIn, X, Instagram, TikTok…). Úsala cuando el
  operador diga "posts para redes", "contenido de social media", "qué publico en Instagram/LinkedIn/X",
  "optimiza mi perfil social", "ideas para redes". NO la uses para multiplicar una pieza ya hecha en
  varias plataformas ([[marketing-content-repurposing]]) ni para la estrategia de contenido
  global/pilares ([[marketing-content-strategy]]).
version: 0.1.0
---
