...
description: >
  Encuentra, cualifica y construye listas de prospectos B2B. Úsala cuando el operador diga "construye
  una lista de prospectos", "encuentra clientes potenciales", "cualifica leads", "a quién le vendo",
  "lista de contactos para outreach". NO la uses para escribir el email en frío
  ([[marketing-cold-email]]) ni para investigación cualitativa de clientes existentes
