...
description: >
  Edita, revisa y mejora copy de marketing ya existente (claridad, tono, concisión, gancho). Úsala
  cuando el operador diga "edita este copy", "revisa este texto", "mejóralo", "pule esta redacción",
  "hazlo más claro/corto", "dale más punch a este texto". NO la uses para escribir copy desde cero
  ([[marketing-copywriting]]) ni para quitar patrones de IA ([[tool-humanizer]]).
version: 0.1.0
---
