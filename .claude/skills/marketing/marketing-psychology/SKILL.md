...
description: >
  Aplica ciencia del comportamiento y modelos mentales al marketing: sesgos cognitivos, principios de
  persuasión (Cialdini), prueba social, escasez, anclaje, framing. Úsala cuando el operador diga "usa
  psicología", "gatillos/disparadores mentales", "principios de persuasión", "por qué la gente
  compra", "sesgos para la conversión", "cómo convenzo mejor". Encaja con [[desbloqueo]] a nivel
  humano pero aquí es persuasión de marketing. NO la uses para escribir el copy final sin objetivo
  psicológico ([[marketing-copywriting]]) ni para pricing en sí ([[marketing-pricing]]).
version: 0.1.0
---
...
> `context/`. "Related Skills" por nombre pelado son aquí `marketing-<nombre>`.
