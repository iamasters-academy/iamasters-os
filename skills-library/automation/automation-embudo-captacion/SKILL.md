...
description: Diseña un embudo de captación orgánica de leads que va de contenido de vídeo corto (Reels/Carruseles) → comentario con palabra clave → DM automático con enlace → landing/formulario → base de datos (Supabase/CRM), entregando guiones de contenido de alto alcance, esqueleto técnico y cuadro de métricas de validación. Es una skill de ESTRATEGIA+DISEÑO de embudo completo, no de construir una pieza suelta. Úsala cuando el operador quiera convertir alcance en redes en leads registrados: "quiero captar leads/clientes/pacientes con Reels o Instagram", "embudo o funnel de conversión desde Instagram/TikTok/redes", "que la gente comente una palabra y le llegue el enlace por DM", "monta el sistema de comenta-palabra→DM automático→landing", "crecer en redes sin seguidores y convertir ese alcance", "lead magnet en redes", "captación orgánica", "growth con Reels", "embudo social". Cubre también el caso de un embudo ya montado del que se pide diseñar la estrategia de contenido o el cuadro de métricas. Aplícala aunque no se nombre "skill"; el disparo es la INTENCIÓN de diseñar el recorrido completo contenido-social→lead, no una palabra suelta. NO la dispares para tareas de UNA sola pieza aislada, que tienen su propia skill: construir/desplegar UN workflow n8n concreto sin la estrategia de embudo detrás (→ automation-n8n-builder), migrar un JSON de n8n/ManyChat ya existente a Claude (→ automation-n8n-to-claude), escribir solo copy/hooks/guiones (→ marketing-copywriting), analizar Meta/Facebook Ads de pago (→ marketing-meta-ads-analyzer), montar una secuencia de emails (→ marketing-email-sequence), crear una tabla Supabase o una landing sueltas sin el embudo (→ automation-client-deploy / backend-development), repurposear vídeo, moderar/responder comentarios, o investigar competidores. Para CONSTRUIR el embudo que esta skill diseña, delega el workflow en automation-n8n-builder y la landing+Supabase en automation-client-deploy.
