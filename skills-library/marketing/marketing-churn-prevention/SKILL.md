...
description: >
  Reduce el churn con flujos de cancelación, ofertas de retención (save offers) y señales de riesgo.
  Úsala cuando el operador diga "reduce el churn", "evita cancelaciones", "flujo de cancelación",
  "oferta de retención", "por qué se van mis clientes", "win-back de cancelados". NO la uses para
  onboarding/activación ([[marketing-onboarding]]) ni para secuencias de email genéricas
