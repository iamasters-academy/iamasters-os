...
description: >
  Gestiona relaciones públicas, earned media y outreach a periodistas: notas de prensa, pitches,
  aparecer en medios. Úsala cuando el operador diga "campaña de PR", "nota de prensa", "contacta
  periodistas", "aparecer en medios", "relaciones públicas", "consigue prensa". NO la uses para
  anuncios de pago ([[marketing-ads]]) ni para co-marketing con partners ([[marketing-co-marketing]]).
version: 0.1.0
---
