...
description: >
  Crea material de ventas y scripts de demo: pitch decks, one-pagers, guiones, objeciones. Úsala
  cuando el operador diga "material de ventas", "pitch deck", "guion de demo", "one-pager de ventas",
  "cómo respondo objeciones", "colateral para cerrar". Encaja con la agencia FIFA y la consultora. NO
  la uses para revops/scoring ([[marketing-revops]]) ni para email en frío ([[marketing-cold-email]]).
version: 0.1.0
---
