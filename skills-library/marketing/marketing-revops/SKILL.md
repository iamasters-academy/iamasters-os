...
description: >
  Gestiona revenue operations y el ciclo de vida del lead: lead scoring, enrutado, handoff a ventas,
  pipeline. Úsala cuando el operador diga "revops", "lead scoring", "gestiona el pipeline de leads",
  "ciclo de vida del lead", "enrutado de leads", "handoff marketing-ventas". NO la uses para prospección
  ([[marketing-prospecting]]) ni para material de ventas ([[marketing-sales-enablement]]).
version: 0.1.0
---
