...
name: marketing-sms
description: >
  Planifica y optimiza campañas de SMS y MMS marketing (cadencias, opt-in, cumplimiento). Úsala cuando
  el operador diga "campaña de SMS", "marketing por SMS/MMS", "mensajes de texto a clientes", "cadencia
  de SMS", "opt-in de SMS". NO la uses para email ([[marketing-email-sequence]]) ni para WhatsApp/DMs
  ([[automation-embudo-captacion]]).
version: 0.1.0
---
