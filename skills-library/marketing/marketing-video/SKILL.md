...
description: >
  Crea, guioniza y produce contenido de vídeo de marketing (reels, shorts, VSL, vídeo para ads).
  Úsala cuando el operador diga "guion de vídeo", "contenido de vídeo", "ideas para reels/shorts",
  "produce un vídeo de marketing", "vídeo para el anuncio". NO la uses para descargar vídeos
  ([[video-downloader]]), transcribir un Reel ([[tool-transcribe-social]]) ni para el análisis de
  vídeo de fútbol (FVI, otro dominio).
version: 0.1.0
---
