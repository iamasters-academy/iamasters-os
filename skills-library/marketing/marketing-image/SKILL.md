...
description: >
  Crea, genera y optimiza imágenes de marketing: gráficos para redes, banners, creatividades visuales.
  Úsala cuando el operador diga "gráficos para redes", "imágenes de marketing", "genera una imagen
  para el post/anuncio", "banner", "creatividad visual". NO la uses para diseño de UI/web
  ([[ui-ux-pro-max]]) ni para aplicar la identidad de marca a artefactos ([[brand-guidelines]]).
version: 0.1.0
---
