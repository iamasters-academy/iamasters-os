...
description: >
  Identifica partners y planifica campañas conjuntas (co-marketing, cross-promotion, alianzas). Úsala
  cuando el operador diga "co-marketing", "busca partners para campañas", "colaboración/alianza de
  marketing", "campaña conjunta", "cross-promotion", "con quién me alío". NO la uses para PR/medios
  ([[marketing-public-relations]]) ni para programas de referidos/afiliación ([[marketing-referrals]]).
version: 0.1.0
---
