...
description: >
  Construye y hace crecer comunidades online para el crecimiento del producto (Discord, Skool, grupos,
  foros). Úsala cuando el operador diga "crea una comunidad", "estrategia de comunidad", "hacer crecer
  una comunidad", "engagement de la comunidad", "monta un grupo/Discord/Skool". NO la uses para
  captación orgánica por contenido social → lead ([[automation-embudo-captacion]]) ni para publicar
  en redes ([[marketing-social]]).
version: 0.1.0
---
