...
description: >
  Configura y audita tracking de eventos y medición (GA4, eventos, atribución). Úsala cuando el
  operador diga "configura GA4", "tracking de eventos", "mide mis conversiones", "audita mi analítica",
  "qué eventos trackeo", "atribución". NO la uses para experimentación/tests ([[marketing-ab-testing]])
  ni para análisis de datos científico ([[exploratory-data-analysis]]).
version: 0.1.0
---
