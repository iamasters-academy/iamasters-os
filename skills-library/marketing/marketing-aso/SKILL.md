...
name: marketing-aso
description: >
  Audita y optimiza fichas de App Store y Google Play (ASO): título, keywords, screenshots, ratings.
  Úsala cuando el operador diga "optimiza mi ficha de la app", "ASO", "app store optimization",
  "keywords de la app", "screenshots de la ficha", "por qué no me descargan". Encaja con apps propias
  (Mente Táctica). NO la uses para SEO web ([[tool-geo-seo-audit]]) ni para ads de apps
  ([[marketing-ads]]).
version: 0.1.0
---
