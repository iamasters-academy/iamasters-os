...
description: >
  Crea y optimiza programas de referidos y afiliación. Úsala cuando el operador diga "programa de
  referidos", "sistema de afiliados", "incentivos por recomendar", "member-get-member", "cómo hago que
  me recomienden". NO la uses para co-marketing con partners ([[marketing-co-marketing]]) ni para
  comunidad ([[marketing-community]]).
version: 0.1.0
---
