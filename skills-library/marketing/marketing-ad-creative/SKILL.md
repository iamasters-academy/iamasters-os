...
description: >
  Genera, itera y escala creatividades de anuncio: headlines, descripciones y anuncios completos.
  Úsala cuando el operador diga "crea creatividades de anuncio", "headlines para ads", "variantes de
  anuncio", "escríbeme anuncios", "iterar creatividades", "ángulos para la campaña". NO la uses para
  gestionar la campaña/targeting ([[marketing-ads]]) ni para analizar rendimiento
