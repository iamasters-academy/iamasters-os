...
name: marketing-ads
description: >
  Gestiona campañas de pago en Google, Meta, LinkedIn y X/Twitter: estructura de campañas, targeting,
  presupuesto, pujas. Úsala cuando el operador diga "monta una campaña de pago", "configura anuncios
  en Google/Meta/LinkedIn", "gestiona mis ads", "estructura de campañas", "cómo reparto el presupuesto
  de ads". NO la uses para diagnosticar campañas Meta existentes por métricas
  ([[marketing-meta-ads-analyzer]]) ni para generar la creatividad ([[marketing-ad-creative]]).
version: 0.1.0
---
