...
description: >
  Crea y optimiza lead magnets (imanes de leads): ebooks, checklists, plantillas, mini-cursos a cambio
  del email. Úsala cuando el operador diga "crea un lead magnet", "imán de leads", "recurso gratuito
  para captar", "ebook/checklist/plantilla de captación", "qué regalo a cambio del email". NO la uses
  para el embudo de captación completo desde redes ([[automation-embudo-captacion]]) ni para
  herramientas gratis como gancho ([[marketing-free-tools]]).
version: 0.1.0
---
