...
description: >
  Envía productos a directorios de startups, SaaS y reseñas (Product Hunt, G2, Capterra, etc.). Úsala
  cuando el operador diga "envía mi producto a directorios", "listar en directorios SaaS/startup",
  "Product Hunt", "G2/Capterra", "submit to directories", "dónde publico mi herramienta". NO la uses
  para SEO on-site ([[tool-geo-seo-audit]]) ni para PR a medios ([[marketing-public-relations]]).
version: 0.1.0
---
